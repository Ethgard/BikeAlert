...
public class Device1Activity extends AppCompatActivity {
    ...
    private static final String DEFAULT_ADDR = "98:D3:31:F9:53:A2";
...
//        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        Notification.Builder builder = new Notification.Builder(Device1Activity.this);

        builder.setAutoCancel(true);
        builder.setTicker("this is ticker text");
        builder.setContentTitle("BikeSensor: Alert!");
        builder.setContentText(name + " is moving!");
...
//        builder.setOngoing(true);
    ...
    private void execute(){
        ...
        if (btSocket != null){
            Device1Activity.Receive receiveThread = new Device1Activity.Receive(btSocket);
            receiveThread.start();
        }
    }
